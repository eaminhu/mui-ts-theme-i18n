...
/**
 * @name link适配器，用于将Next.js的Link组件与MUI一起使用。
 * @link https://mui.com/material-ui/guides/routing/#link
 *  * Demos:
 *
 * - [ButtonLink]
 * ```
 *  <Button component={NextLinkComposed} to={{ pathname: '/about', query: { name: 'test' },}} >Button link</Button>
 * ```
 *  - [Link]
 * ```
 *  <Link href={{pathname: '/about', query: { name: 'test' },}}> Link </Link>
 * ```
 */
